  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isNewClient) {
        ...
        // Handle BigInt return type from Kysely
        clientId = Number(newClient.insertId);
      }
    ...
    <div className="max-w-4xl mx-auto p-6 pb-20">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
           ...
           <div>
             <label className="block text-sm font-medium text-gray-700">Serial / Sticker No</label>
             <input type="text" className="w-full input bg-slate-50 border-gray-300 mt-1" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
           ...
           <div>
             ...
             <input min={0} type="number" className="w-full input bg-slate-50 border-gray-300 mt-1" 
               value={device.deposit} onChange={e => setDevice({...device, deposit: Number(e.target.value)})} />
           </div>
        </div>
